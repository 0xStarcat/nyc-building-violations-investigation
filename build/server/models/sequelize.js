...
var sequelize = new Sequelize('sqlite://bk_building_violation_project.sqlite', {
  pool: {
    max: 5,
    min: 0,
    acquire: 30000,
...
db.BuildingEvent.prototype.getItem = function (options) {
  return this['get' + this.get('eventable').substr(0, 1).toUpperCase() + this.get('eventable').substr(1)](options);
};
